...
public class NoticeDemoMockService {
    ...
    private void saveCoverLetterQuestions(User user, Notice notice) {
        coverLetterItemRepository.save(CoverLetterItem.builder()
                .user(user)
                .notice(notice)
                .question("1. 부산창조경제혁신센터와 초기창업패키지 사업에 지원하게 된 동기를 작성해 주세요.")
                .maxLength(500)
                .orderIndex(1)
                .aiGenerated(true)
                .build());
        coverLetterItemRepository.save(CoverLetterItem.builder()
                .user(user)
                .notice(notice)
                .question("2. 지원 직무와 관련해 본인의 역량을 발휘한 경험을 구체적으로 작성해 주세요.")
                .maxLength(700)
                .orderIndex(2)
                .aiGenerated(true)
                .build());
        coverLetterItemRepository.save(CoverLetterItem.builder()
                .user(user)
                .notice(notice)
                .question("3. 창업기업 또는 프로그램 참여자와 소통하며 문제를 해결했던 경험을 작성해 주세요.")
                .maxLength(700)
                .orderIndex(3)
                .aiGenerated(true)
                .build());
        coverLetterItemRepository.save(CoverLetterItem.builder()
                .user(user)
                .notice(notice)
                .question("4. 입사 후 초기창업패키지 사업 운영에 기여하고 싶은 방향을 작성해 주세요.")
                .maxLength(500)
                .orderIndex(4)
                .aiGenerated(true)
                .build());
